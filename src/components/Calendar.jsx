...
const Calendar = () => {
  return (
    <div className="module ms-2">
      <section className="cal-title d-flex justify-content-between align-items-center" style={{color:'#041c7d'}}>
        <h4>october 2021</h4>
        <div className="px-4">
      ...
      <section className="table" >
        <table className="cal-table" st>
          <tr>
            ...
            <td style={{backgroundColor:'#c7c5c523',borderTopLeftRadius:'10px',borderTopRightRadius:'10px'}}>
          ...
          <tr>
            ...
            <td>12:00</td>
            <td>10:00</td>
            <td  className="opacity-50"><sup><sup>_________</sup></sup></td>
            <td  className="opacity-50" colSpan={2} ><span style={{backgroundColor:'#041c7d' ,borderRadius:'10px',color:'white',padding:'5px 15px'}}>12:00 <span className="ms-4">09:00</span></span></td>
          </tr>
           <tr>
            <td>11:00</td>
            <td style={{backgroundColor:'#c7c5c523'}}><span style={{backgroundColor:'#041c7d' ,borderRadius:'10px',color:'white',padding:'5px 12px'}}>09:00</span></td>
            <td><sup><sup>_________</sup></sup></td>
            <td><span style={{backgroundColor:'#041c7d' ,borderRadius:'10px',color:'white',padding:'5px 12px'}}>11:00</span></td>
            <td>14:00</td>
            <td>14:00</td>
           ...
           <tr>
            <td>12:00</td>
            <td style={{backgroundColor:'#c7c5c523',borderBottomLeftRadius:'10px',borderBottomRightRadius:'10px'}}>10:00</td>
            <td>13:00</td>
            <td><sup><sup>_________</sup></sup></td>
            <td>16:00</td>
            <td>15:00</td>
